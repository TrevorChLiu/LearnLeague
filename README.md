...
Sometimes the table in the database might be outdated after project files update. In this case, run `python remote_server.py reset` in the home directory to reset the database. You can also run `python remote_server.py demo` to get a demo.